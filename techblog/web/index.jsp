    ...
    <%@include  file="normalnavbar.jsp"%>  
        ...
        <div class="conatiner-fluid p-0 m-0">
            <div class="jumbotron primary-background text-white" >
                ...
                <div class="container"> 
                <h3 class="display-2">welcome to technical blog</h3>
                <p> Welcome to Technical Blog world of technology <br>
                ...
                <button class="btn btn-outline-light btn-lg"><span class="fa   fa fa-user-plus"></span>Start its freee</button>
